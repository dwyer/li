...
/* is this overkill? */
#define caar(obj)               li_car(li_car(obj))
#define cadr(obj)               li_car(li_cdr(obj))
#define cdar(obj)               li_cdr(li_car(obj))
#define cddr(obj)               li_cdr(li_cdr(obj))
#define caaar(obj)              li_car(li_car(li_car(obj)))
#define caadr(obj)              li_car(li_car(li_cdr(obj)))
#define cadar(obj)              li_car(li_cdr(li_car(obj)))
#define caddr(obj)              li_car(li_cdr(li_cdr(obj)))
#define cdaar(obj)              li_cdr(li_car(li_car(obj)))
#define cdadr(obj)              li_cdr(li_car(li_cdr(obj)))
#define cddar(obj)              li_cdr(li_cdr(li_car(obj)))
#define cdddr(obj)              li_cdr(li_cdr(li_cdr(obj)))
#define caaaar(obj)             li_car(li_car(li_car(li_car(obj))))
#define caaadr(obj)             li_car(li_car(li_car(li_cdr(obj))))
#define caadar(obj)             li_car(li_car(li_cdr(li_car(obj))))
#define caaddr(obj)             li_car(li_car(li_cdr(li_cdr(obj))))
#define cadaar(obj)             li_car(li_cdr(li_car(li_car(obj))))
#define cadadr(obj)             li_car(li_cdr(li_car(li_cdr(obj))))
#define caddar(obj)             li_car(li_cdr(li_cdr(li_car(obj))))
#define cadddr(obj)             li_car(li_cdr(li_cdr(li_cdr(obj))))
#define cdaaar(obj)             li_cdr(li_car(li_car(li_car(obj))))
#define cdaadr(obj)             li_cdr(li_car(li_car(li_cdr(obj))))
#define cdadar(obj)             li_cdr(li_car(li_cdr(li_car(obj))))
#define cdaddr(obj)             li_cdr(li_car(li_cdr(li_cdr(obj))))
#define cddaar(obj)             li_cdr(li_cdr(li_car(li_car(obj))))
#define cddadr(obj)             li_cdr(li_cdr(li_car(li_cdr(obj))))
#define cdddar(obj)             li_cdr(li_cdr(li_cdr(li_car(obj))))
#define cddddr(obj)             li_cdr(li_cdr(li_cdr(li_cdr(obj))))
