...
#define cadr(obj)               li_car(cdr(obj))
#define cdar(obj)               cdr(li_car(obj))
#define cddr(obj)               cdr(cdr(obj))
#define caaar(obj)              li_car(li_car(li_car(obj)))
#define caadr(obj)              li_car(li_car(cdr(obj)))
#define cadar(obj)              li_car(cdr(li_car(obj)))
#define caddr(obj)              li_car(cdr(cdr(obj)))
#define cdaar(obj)              cdr(li_car(li_car(obj)))
#define cdadr(obj)              cdr(li_car(cdr(obj)))
#define cddar(obj)              cdr(cdr(li_car(obj)))
#define cdddr(obj)              cdr(cdr(cdr(obj)))
#define caaaar(obj)             li_car(li_car(li_car(li_car(obj))))
#define caaadr(obj)             li_car(li_car(li_car(cdr(obj))))
#define caadar(obj)             li_car(li_car(cdr(li_car(obj))))
#define caaddr(obj)             li_car(li_car(cdr(cdr(obj))))
#define cadaar(obj)             li_car(cdr(li_car(li_car(obj))))
#define cadadr(obj)             li_car(cdr(li_car(cdr(obj))))
#define caddar(obj)             li_car(cdr(cdr(li_car(obj))))
#define cadddr(obj)             li_car(cdr(cdr(cdr(obj))))
#define cdaaar(obj)             cdr(li_car(li_car(li_car(obj))))
#define cdaadr(obj)             cdr(li_car(li_car(cdr(obj))))
#define cdadar(obj)             cdr(li_car(cdr(li_car(obj))))
#define cdaddr(obj)             cdr(li_car(cdr(cdr(obj))))
#define cddaar(obj)             cdr(cdr(li_car(li_car(obj))))
#define cddadr(obj)             cdr(cdr(li_car(cdr(obj))))
#define cdddar(obj)             cdr(cdr(cdr(li_car(obj))))
